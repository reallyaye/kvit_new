...
<head>
  ...
  <title>Отчет инвестиционной программы и тарифной сметы за 3 квартал 2024 года</title>
  <style>
    table {
        width: 100%;
...
<body>
  <h1>Отчет инвестиционной программы и тарифной сметы за 3 квартал 2024 года</h1>

  <div class="content">
    <iframe height="900" src="../files/invest-3-2024.pdf" width="100%" style="border: none;"></iframe>
  </div>
    <table>
        <tr>
            <th colspan="8">Капитальный ремонт с увеличением балансовой стоимости ВЛ 6 кВ ф.№57 от ПС "Тентекская ТЭЦ" (Абайский район)
</th>
        </tr>
        <tr>
            <td class="image-container">
                <img src="../images/5.61.jpeg">
            </td>
            <td class="image-container">
                <img src="../images/5.62.jpeg">
            </td>
			<td class="image-container">
                <img src="../images/5.63.jpeg">
            </td>
            <td class="image-container">
                <img src="../images/5.64.jpeg">
            </td>
            <td class="image-container">
                <img src="../images/5.65.jpeg">
            </td>
			<td class="image-container">
                <img src="../images/5.66.jpeg">
            </td> 
        </tr>
    </table>
  <!-- Другой контент, который может быть раскомментирован по мере необходимости -->
  <!-- <div class="buttom">
