...
def render_login_form(error_msg: str = None):
    ...
    return f'''<div class="card login-card">
        ...
        <div style="margin-top:16px;text-align:center">
            <a class="back-link" href="/" style="display:inline-flex;align-items:center;gap:4px">{icon('arrow_left', 13)} На главную</a>
        </div>
    </div>'''
...
def render_rate_limit_page(retry_after: int):
    return f'''<div class="card">
        ...
        <a class="btn-outline btn" href="/" style="display:inline-flex;align-items:center;gap:6px">{icon('arrow_left', 14)} Вернуться на главную</a>
    </div>'''
...
def render_throttled_page(retry_after: int):
    return f'''<div class="card">
        ...
        <a class="btn-outline btn" href="/" style="display:inline-flex;align-items:center;gap:6px">{icon('arrow_left', 14)} На главную</a>
    </div>'''
