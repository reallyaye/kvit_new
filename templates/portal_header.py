...
def render_admin_bar(is_admin: bool, current_slug: str = "") -> str:
    """Рендерит плавающую панель управления для авторизованных сотрудников."""
    if not is_admin:
        return ""
...
def render_portal_header(active_nav: str, locale: str, ru_path: str, kk_path: str) -> str:
    """Рендерит шапку и основную навигацию информационного портала ТОО «КРЭК»."""
    return f'''
<header class="krec-header" id="krecHeader">
    <div class="krec-header-container">
        ...
        <!-- Правый блок: Языки и Бургер-меню -->
